  ...
  return (
    <div ref={ref} className="lr-print-root lr3-root" style={{ width: 1000, height: 670, background: '#fff', color: '#111' }}>
      <style>{`
        ...
        .lr3-root{font-family:Arial,sans-serif;padding:10px;font-size:10px}
        .lr3-root .lr3-sheet{width:980px;height:650px;border:1.5px solid #111;overflow:hidden;background:#fff}
        .lr3-root .lr3-header{height:150px;display:grid;grid-template-columns:76% 24%;grid-template-rows:90px 60px;border-bottom:1px solid #111}
        .lr3-root .lr3-company{display:grid;grid-column:1;grid-row:1;grid-template-columns:108px minmax(0,1fr);column-gap:18px;align-items:center;padding:8px 12px;border-right:1px solid #111;border-bottom:1px solid #111;background:#f2f3f3}
        .lr3-root .lr3-company img{display:block;width:108px;height:48px;object-fit:contain;justify-self:start}.lr3-root .lr3-company>div{min-width:0}.lr3-root .lr3-company h1{margin:0 0 5px;font-size:21px;line-height:1;font-weight:900;letter-spacing:.4px}.lr3-root .lr3-company p{margin:0;font-size:9px;line-height:1.3;color:#111}
        .lr3-root .lr3-note{display:flex;grid-column:2;grid-row:1 / span 2;flex-direction:column;align-items:center;justify-content:center;gap:5px;text-align:center;padding:8px 10px}.lr3-root .lr3-note small{flex-shrink:0;font-family:"Arial Black",Arial,sans-serif;font-size:10px;line-height:13px;font-weight:900;letter-spacing:1.4px}.lr3-root .lr3-note strong{font-size:22px;line-height:1.15;margin:5px 0;overflow-wrap:anywhere}.lr3-root .lr3-note .lr3-barcode{display:block;flex-shrink:0;width:100%;max-width:215px;height:68px;margin:0 auto}.lr3-root .lr3-note span{flex-shrink:0;font-size:9px;line-height:11px;font-weight:900}
        .lr3-root .lr3-route{height:60px;display:grid;grid-column:1;grid-row:2;grid-template-columns:.75fr .75fr 1fr 1fr .9fr;border-right:1px solid #111;border-bottom:1px solid #111;background:#f6f7f7}
        .lr3-root .lr3-route div{padding:7px 8px;border-right:1px solid #777;overflow:hidden}.lr3-root .lr3-route div:last-child{border:0}.lr3-root .lr3-route span,.lr3-root .lr3-field span{display:block;font-size:7.5px;line-height:8px;font-weight:900;text-transform:uppercase;letter-spacing:.35px;margin-bottom:4px}.lr3-root .lr3-route strong{display:block;font-size:12px;line-height:20px;white-space:nowrap}
        ...
        .lr3-root .lr3-receiver{height:87px;padding:7px 8px;display:grid;grid-template-columns:1fr 1fr;gap:7px}.lr3-root .lr3-receiver>div{display:grid;grid-template-rows:8px 18px 8px 18px;row-gap:3px;align-content:start}.lr3-root .lr3-receiver span{display:block;font-size:7.5px;line-height:8px;font-weight:900;text-transform:uppercase;margin:0}.lr3-root .lr3-receiver strong{display:block;min-height:18px;font-size:9px;line-height:18px;overflow-wrap:anywhere}
        .lr3-root .lr3-service{height:46px;padding:6px 7px;border-bottom:1px solid #111;display:flex;gap:8px;align-content:center;flex-wrap:wrap}.lr3-root .lr3-tick{display:flex;align-items:center;gap:3px;font-size:7.5px;white-space:nowrap}.lr3-root .lr3-tick i{width:11px;height:11px;border:1px solid #555;display:flex;align-items:center;justify-content:center;font-size:8px;font-style:normal}.lr3-root .lr3-tick i em,.lr3-root .lr3-tick b{position:relative;top:-5px}.lr3-root .lr3-tick i em{font-style:normal}.lr3-root .lr3-tick b{font-weight:800}
        .lr3-root .lr3-charge-title{height:24px;padding:7px 7px 5px;background:#dfe2e2;border-bottom:1px solid #111;font-size:9px;line-height:1;font-weight:900;text-transform:uppercase}
        .lr3-root .lr3-charge{height:22px;padding:5px 7px;border-bottom:1px solid #888;display:grid;grid-template-columns:1fr auto;gap:5px;font-size:8.5px;line-height:11px}.lr3-root .lr3-charge strong{text-align:right}
        .lr3-root .lr3-charge.emphasis{font-weight:900;background:#f0f1f1}.lr3-root .lr3-charge.total{height:27px;padding-top:7px;background:#222;color:#fff;font-size:10px}.lr3-root .lr3-charge.total span,.lr3-root .lr3-charge.total strong{position:relative;top:-5px}
        .lr3-root .lr3-payment{height:48px;padding:6px 7px;border-bottom:1px solid #111}.lr3-root .lr3-payment>span{display:block;font-size:7.5px;font-weight:900;text-transform:uppercase;margin-bottom:6px}.lr3-root .lr3-payment div{display:flex;gap:8px;flex-wrap:wrap}
        .lr3-root .lr3-pricing{height:33px;padding:0 7px;border-bottom:1px solid #111;color:#111;font-size:9px;line-height:12px;font-weight:600;display:flex;align-items:center;text-align:left}.lr3-root .lr3-pricing span{position:relative;top:1px;white-space:nowrap}.lr3-root .lr3-insurance{height:45px;padding:7px;color:#111;font-size:9px;font-weight:700;display:flex;align-items:center;justify-content:space-between;gap:7px}.lr3-root .lr3-insurance strong{font-size:10px;font-weight:900}
        .lr3-root .lr3-footer{height:55px;display:grid;grid-template-columns:36% 35% 29%}.lr3-root .lr3-footer>div{padding:8px;border-right:1px solid #111}.lr3-root .lr3-footer>div:last-child{border:0}.lr3-root .lr3-footer span{display:block;font-size:7.5px;font-weight:900;text-transform:uppercase;margin-bottom:5px}.lr3-root .lr3-footer strong{display:block;font-size:9px;line-height:1.3;overflow-wrap:anywhere}.lr3-root .lr3-terms{font-size:8px;line-height:1.3}
      `}</style>
      ...
      <div className="lr3-sheet">
        <header className="lr3-header">
          ...
          <div className="lr3-note"><small>CONSIGNMENT NOTE</small><LrBarcode value={s.lrNumber} className="lr3-barcode" /><span>RECIEVER COPY</span></div>
